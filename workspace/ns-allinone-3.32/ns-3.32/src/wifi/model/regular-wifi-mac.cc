    ...
    m_dsssSupported (0)
{
  ...
  m_txop->SetTxOkPacketCallback (MakeCallback (&RegularWifiMac::TxPacketOk, this));
  ...
  m_txop->SetRequestAccessCallback (MakeCallback (&RegularWifiMac::RequestChannelAccess, this));
...
RegularWifiMac::SetupEdcaQueue (AcIndex ac)
{
  ...
  edca->SetTxOkPacketCallback (MakeCallback (&RegularWifiMac::TxPacketOk, this));
  edca->SetRequestAccessCallback (MakeCallback (&RegularWifiMac::RequestChannelAccess, this));
...
RegularWifiMac::GetTypeId (void)
{
  static TypeId tid = TypeId ("ns3::RegularWifiMac")
    ...
    .AddAttribute ("BK_Txop",
                   ...
                   MakePointerChecker<QosTxop> ())
    .AddTraceSource ("RequestChannelPacket",
                     "The header of requested chanel access packet",
                     MakeTraceSourceAccessor (&RegularWifiMac::m_requestChannelAccessCallback),
    ...
    .AddTraceSource ("TxOkHeader",
                     ...
                     "ns3::WifiMacHeader::TracedCallback")
    .AddTraceSource ("TxOkCallback",
                     "The successfully packet.",
                     MakeTraceSourceAccessor (&RegularWifiMac::m_txOkPacketCallback),
                     "ns3::WifiMacHeader::TracedCallback")                 
...
void
RegularWifiMac::TxPacketOk (Ptr<const Packet> item)
{
  NS_LOG_FUNCTION (this << item);
  m_txOkPacketCallback (item);
} 

void
RegularWifiMac::RequestChannelAccess (const WifiMacQueueItem &item)
{
  NS_LOG_FUNCTION (this << item);
  m_requestChannelAccessCallback (item);
}
