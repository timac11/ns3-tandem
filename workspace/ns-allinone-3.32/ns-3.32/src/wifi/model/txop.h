...
public:
   ...
   * packet transmission was completed successfully.
   */
  typedef Callback <void, Ptr<const Packet>> TxOkPacket;
  /**
   * typedef for a callback to invoke when a
   * packet transmission was started
   */
  typedef Callback <void, const WifiMacQueueItem&> RequestAccess;
  ...
  void SetTxOkPacketCallback (TxOkPacket callback);
  /**
   * \param callback the callback to invoke when a
   * packet start to request access to chanel
   */
  void SetRequestAccessCallback(RequestAccess callback);
...
protected:
  ...
  TxOkPacket m_txOkPacketCallback;                  //!< the transmit OK callback
  RequestAccess m_requestAccessCallback;            //!< the request access to chanel
