...
{   
    if (!requested && item.GetPacket()->GetSize() == 1000) {
...
{ 
    std::cout << "ACK: " << requested << " " << item->GetSize() << std::endl;
    if (requested && item->GetSize() == 1000) {
        this->ackCount ++;
...
experiment(uint32_t stationsNumber, uint32_t simulationTime, std::string filePrefix,  double delay) {
    ...
    uint32_t payloadSize = 972; //bytes
    uint16_t port = 5000;
...
main(int argc, char **argv) {
    ...
    //    std::cout << "experment # " + std::to_string(i) << std::endl;
        experiment(4, 2500, std::to_string(0) + "_lambda=100_250000_packets_count" + "_experiment_802_11_N_", 0.01);
    //}
    ...
    //for (int i = 0; i < 10; i ++) {
    //    std::cout << "experment # " + std::to_string(i) << std::endl;
        experiment(4, 2500, std::to_string(0) + "_lambda=50_250000_packets_count" + "_experiment_802_11_N_", 0.02);
    //}
    ...
    //for (int i = 0; i < 10; i ++) {
    //    std::cout << "experment # " + std::to_string(i) << std::endl;
        experiment(4, 2500, std::to_string(0) + "_lambda=200_250000_packets_count" + "_experiment_802_11_N_", 0.005);
    //}
    ...
    //for (int i = 0; i < 10; i ++) {
    //    std::cout << "experment # " + std::to_string(i) << std::endl;
        experiment(4, 2500, std::to_string(0) + "_lambda=500_250000_packets_count" + "_experiment_802_11_N_", 0.002);
    //}
